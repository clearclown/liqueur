...
const MOCK_TEMPLATES: Record<string, () => unknown[]> = {
  ...
  expenses: () => [
    { date: "2024-01-15", category: "Food", amount: 45.5, merchant: "Restaurant A" },
    { date: "2024-01-20", category: "Travel", amount: 120.0, merchant: "Airline B" },
    { date: "2024-02-05", category: "Office", amount: 89.99, merchant: "Supplier C" },
    { date: "2024-02-10", category: "Food", amount: 32.0, merchant: "Cafe D" },
    { date: "2024-03-01", category: "Entertainment", amount: 75.0, merchant: "Cinema E" },
